...
st.info("App loaded successfully! Running setup...")
time.sleep(1)
st.success("UI initialized — now loading data and models.")
...
try:
    if ticker:
        ...
        if df.empty:
            st.error("No data returned. Check if the ticker is valid and date range is correct.")
        else:
